  ...
  const text =
    lang === "ru"
      ? {
          ...
          livePaymentHint: "Платеж обработает подключенный платежный провайдер, а финальный статус обновится автоматически.",
          routeTitle: "Этапы оплаты",
          routeHint: "Покажем, где сейчас находится оплата: способ, обработка и результат.",
          routeMethod: "Способ",
      ...
      : {
          ...
          routeTitle: "Payment steps",
          routeHint: "Shows where payment is now: method, processing, and result.",
          routeMethod: "Method",
